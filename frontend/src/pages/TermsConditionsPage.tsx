          ...
          <div className="glass-card glow-border p-8 sm:p-10 space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed mt-4">
                These Terms and Conditions (“Terms”) govern your access to and use of the website https://www.bdcode.in/ (the “Website”), operated by bdcode_ (“bdcode_”, “we”, “our”, or “us”).
              </p>
